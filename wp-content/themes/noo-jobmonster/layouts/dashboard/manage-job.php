            ...
            <div class="noo-dashboard-table">
                <table class="table noo-datatable" id="noo-table-job">
                    ...
                    <tr>
                        ...
                        <th class="hidden-xs  text-center"><?php _e('Apps', 'noo') ?></th>
                        <th class="hidden-xs text-center"><?php _e('Status', 'noo') ?></th>
                        ...
                        <?php while ($r->have_posts()): $r->the_post();
                            ...
                            <tr>
                                ...
                                <td class="member-manage-actions text-center">
                                    ...
                                    $remain_refresh_job = sprintf(esc_html__('Remain %s refresh time.', 'noo'), $remain_refresh_job);
                                    // check job refresh unlimit -1 <-> 99999999 refresh times
                                    if(strlen((string)$job_refresh) >= 7) $remain_refresh_job = esc_html__('Unlimited refresh time.','noo');
                                    ?>
                                    <?php if($job_refresh > 0): ?>
                                        <span class="btn-refresh-job" data-id="<?php echo get_the_ID(); ?>"
                                              data-refresh="<?php echo esc_attr($remain_refresh_job); ?>"
                                              data-toggle="tooltip"
                                              title="<?php echo esc_attr__($remain_refresh_job); ?>">
