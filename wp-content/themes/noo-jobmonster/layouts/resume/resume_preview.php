				...
				<?php 
					if($query->post_count){
						...
						<div class="form-actions job-preview-actions text-center clearfix">
							...
							$submit_agreement = !is_null( $submit_agreement ) ? $submit_agreement : sprintf(__('The employer can find your resume and contact you via email or regarding your resume. Preview all information thoroughly before submitting your resume for approval.','noo'), get_bloginfo('name') );
