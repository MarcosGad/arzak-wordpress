    ...
    <div id="company-desc" class="company-desc" <?php echo ($schema_company);?>>
        ...
        <div class="company-header">
            <div class="company-featured"><a
                        href="<?php echo get_permalink($company_id); ?>" <?php echo ($schema_url);?>><span <?php echo ($schema_logo);?>><?php echo $logo_company; ?></span></a></div>
        ...
        <div class="company-info">
            ...
            if (!empty($html) && count($html) > 0) : ?>
                <div class="job-social clearfix">
                    <span class="noo-social-title"><?php echo esc_html__('Connect with us', 'noo'); ?></span>
                    <?php echo implode("\n", $html); ?>
                </div>
            <?php endif; ?>
        </div>
