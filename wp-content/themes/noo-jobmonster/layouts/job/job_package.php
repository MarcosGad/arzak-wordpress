                        ...
                        <div class="pricing-info">
                            <ul class="noo-ul-icon fa-ul">
                                ...
                                <?php if ($is_unlimited || $job_limit > 0) : ?>
                                    <li class="noo-li-icon"><i
                                                class="fa fa-check-circle"></i> <?php echo esc_html($job_posting_text); ?></li>
                                <?php else : ?>
                                    <li class="noo-li-icon"><i
                                ...
                                <?php if ($featured_limit > 0) : ?>
                                    <li class="noo-li-icon"><i
                                                class="fa fa-check-circle"></i> <?php echo esc_html($job_featured_text); ?></li>
                                <?php else : ?>
                                    <li class="noo-li-icon"><i
                                ...
                                <?php if ($refresh_limit > 0) : ?>
                                    <li class="noo-li-icon"><i
                                                class="fa fa-check-circle"></i> <?php echo esc_html($job_refresh_text); ?></li>
                                <?php else : ?>
                                    <li class="noo-li-icon"><i
                                ...
                                <?php if($download_resume_limit > 0): ?>
                                    <li class="noo-li-icon"><i class="fa fa-check-circle"></i><?php esc_html_e($download_resume_limit_text); ?></li>
                                <?php else: ?>
                                    <li class="noo-li-icon"><i class="fa fa-times-circle-o not-good"></i><?php esc_html_e('No Download Resume Attach file','noo') ?></li>
                                <?php endif; ?>
                                <?php if ($is_unlimited || $job_limit > 0) : ?>
                                    <li class="noo-li-icon"><i
                                                class="fa fa-check-circle"></i> <?php echo esc_html($job_duration_text); ?></li>
                                <?php endif; ?>
