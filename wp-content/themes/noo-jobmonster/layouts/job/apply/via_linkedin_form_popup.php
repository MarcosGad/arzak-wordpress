                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="in-profile-overview">
                                        <div class="in-profile-name"><?php echo $display_name ; ?></div>
                                        <div class="in-profile-headline"><?php echo esc_html__($user_linked['headline'],'noo'); ?></div>
                                        <div class="in-profile-location"><?php echo esc_html__($user_linked['location']['name'],'noo'); ?></div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            <dl>
                                ...
                                <dd class="in-profile-positions"><ul>
                                        <li><?php echo esc_html__($user_linked['positions']['positions_current'].'-'.$user_linked['positions']['current_company'],'noo') ?></li>
                                    </ul></dd>
                                <?php endif; ?>
