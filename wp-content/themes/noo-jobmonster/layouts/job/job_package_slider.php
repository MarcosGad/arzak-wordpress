				        ...
				        <div class="pricing-info">
				            <ul class="noo-ul-icon fa-ul">
                                ...
                                <?php if($download_resume_limit > 0): ?>
                                    <li class="noo-li-icon"><i class="fa fa-check-circle"></i><?php echo $download_resume_limit_text; ?></li>
                                <?php else: ?>
                                    <li class="noo-li-icon"><i class="fa fa-times-circle-o not-good"></i><?php echo __('No Download Resume','noo') ?></li>
                                <?php endif; ?>
				                <?php if( $is_unlimited || $job_limit > 0 ) : ?>
