...
if ( ! empty( $heading ) ) :
	...
	<?php if ( is_post_type_archive( 'noo_job' ) or is_tax( 'job_category' ) or is_tax( 'job_location' ) or is_tax('job_type') or is_tax('job_tag')): ?>
				...
				<div class="page-sub-heading-info">
					<?php if ( is_singular( 'noo_job' ) ) :
						...
						$company_title 	= get_the_title($company_id);
							...
							echo '<h3 class="company-title"> '. $company_title .' </h3>';
						}
                            ...
                            <?php if ( in_array( 'resume-alert', $employer_heading_values ) or empty( $employer_heading_values ) ) : ?>
                                <?php if ( Noo_Resume_Alert::enable_resume_alert() ) : ?>
                                    <li class="<?php echo esc_attr( Noo_Member::get_actice_enpoint_class( array(
                                        ...
                                        'add-resume-alert',
                                        'edit-resume-alert',
                                    ) ) ) ?>"><a href="<?php echo Noo_Member::get_endpoint_url( 'resume-alert' ) ?>"><i
