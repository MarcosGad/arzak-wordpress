	...
	function jm_noo_job_search_shortcode( $atts, $content = null ) {
        ...
        <div class="noo-job-search-wrapper <?php echo esc_attr( $class ); ?>" <?php echo( $id_out . ' ' . $custom_style ); ?>>
			...
			if ( $background_type == 'revo_slider' ) : ?>
                ...
                <div class="container">
                	<div
	                    class="job-advanced-search job-revo-slider <?php echo $align_title ?> <?php echo( $search_mode == 'noo_vertical' ? ' vertical' : ' horizontal ' . $style_horizontal ); ?> column-<?php echo esc_attr( $fields_count ); ?>" <?php if ( ! empty( $search_position ) ) {
			...
			<?php else: ?>
				...
				<div class="job-search-bg-image <?php if ( $background_type == 'slider' ) { echo 'job-search-slider'; } ?>" <?php echo $style_bg; ?>>
					<div class="container job-advanced-search-container">
		                <div class="job-advanced-search <?php echo $align_title ?> <?php echo( $search_mode == 'noo_vertical' ? ' vertical' : ' horizontal ' . $style_horizontal ); ?> column-<?php echo esc_attr( $fields_count ); ?>" <?php if ( ! empty( $search_position ) ) {
							echo 'style="top: ' . intval( $search_position ) . 'px;"';
							} ?>>
		                    <div class="job-search-info <?php echo $align_title ?>">
								<?php if ( ! empty( $title ) ) : ?>
