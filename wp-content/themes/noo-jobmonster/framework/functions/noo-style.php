...
if(!function_exists('noo_half_map_class')):
    function noo_half_map_class(){
        $class = '';
        $job_map_archive = noo_get_option('noo_jobs_layout','');
        $resume_map_archive = noo_get_option('noo_resumes_layout','');
        ...
        if($is_resumes){
            if($resume_map_archive == 'fullwidth_map' || $mode_type =='map'){
                $class = 'archive_with_map';
            }
        }elseif ($is_jobs){
            if($job_map_archive =='map_full_width' || $mode_type =='map'){
                $class = 'archive_with_map';
            }
        }
        return $class;
