...
if ( ! function_exists( 'noo_customizer_register_options_job' ) ) :
	function noo_customizer_register_options_job( $wp_customize ) {
		...
		$helper->add_control(
			...
			array(
				'choices' => array(
                    'map_full_width' => __('With Map','noo'),
                    'fullwidth'   => __( 'Full-Width', 'noo' ),
                    'sidebar'   => __( 'With Right Sidebar', 'noo' ),
                    'left_sidebar'   => __( 'With Left Sidebar', 'noo' )
				),
				'json' => array(
					'child_options' => array(
                        'map_full_width'=>'noo_jobs_map_align,noo_jobs_map_sidebar_align,noo_jobs_sidebar',
                        'fullwidth'   => '',
        ...
        $helper->add_control(
            'noo_jobs_map_align',
            'noo_radio',
            esc_html__('Map Position','noo'),
            'right',
            array(
                'choices' => array(
                    'right' => __('Map on Right','noo'),
                    'left'  => __('Map on Left','noo')
                ),
            ),
            array('transport' => 'postMessage')
        );
        $helper->add_control(
            'noo_jobs_map_sidebar_align',
            'noo_radio',
            esc_html__('Sidebar Position on Map Layout','noo'),
            'pull-right',
            array(
                'choices' => array(
                    'pull-left' => esc_html__('With Right Sidebar','noo'),
                    'pull-right'=> esc_html__('With Left Sidebar','noo'),
                ),
            ),
            array('transport' => 'postMessage')
        );
		...
		$helper->add_control(
			...
			1,
			array(
			    'json' => array('on_child_options'=> 'noo_show_job_location_search,noo_show_job_category_search,noo_job_search_field_type'),
            ),
			array( 'transport' => 'postMessage' )
		);
	...
	function noo_customizer_register_options_resume( $wp_customize ) {
		...
		$helper->add_control(
			...
			array(
				...
				'json' => array(
					'child_options' => array(
                        'fullwidth_map'=>'noo_resume_map_align,noo_resume_map_sidebar_align,noo_resumes_sidebar',
						'fullwidth'   => '',
        ...
        $helper->add_control(
            ...
            0,
            array(
                'json' => array('on_child_options'=> 'noo_show_resume_location_search,noo_show_resume_category_search,noo_resume_search_field_type'),
            ),
            array( 'transport' => 'postMessage' )
        );
        // show job location search
