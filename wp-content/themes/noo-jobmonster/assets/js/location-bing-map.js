                                ...
                                if (data !== "-1") {
                                    ...
                                    jQuery(data).on('click','.mobile-job-filter', function(){
                                        ...
                                        if(filter_class.hasClass('on-filter')){
                                            ...
                                            jQuery(this).html('<i class="fa fa-close" aria-hidden="true"></i>' + nooJobL10n.close);
                                            filter_class.append('<span class="close-mobile-job-filter" style="float: right"><i class="fa fa-close" aria-hidden="true"></i>' + nooJobL10n.close +'</span>');
                                        }
                                    });
            ...
            var jobLiveFilter = function(){
                ...
                if(!is_tax){
                    jQuery('#' + form_id + ' .reset-search').on('click',function (e) {
                        ...
                        jQuery('select.form-control').multiselect('refresh');
