        ...
        <form
            ...
            <?php if($show_keyword == 'yes'): ?>
                <div class="form-group">
                    ...
                    <input type="text"  class="form-control " id="<?php echo $prefix.'_search-keyword'; ?>" data-value="<?php echo esc_url(noo_upload_url()) ?>/job-tags.json"  name="s" placeholder="<?php esc_html_e('Keyword','noo') ?>" value="<?php echo (isset($_GET['s'])) ? esc_attr($_GET['s']) : ''; ?>">
                </div>
            <?php else: ?>
                <input type="hidden" name ="s" value="">
            <?php endif; ?>
    ...
    public function widget( $args, $instance ) {
        ...
        <form
            ...
            <?php if($show_keyword == 'yes'): ?>
                <div class="form-group">
                    <label class="sr-only" for="<?php echo $prefix.'_search-keyword'; ?>"><?php esc_html_e('Keyword','noo'); ?></label>
                    <input type="text" class="form-control" id="<?php echo $prefix. '_search-keyword'; ?>" name="s" placeholder="<?php esc_html_e('Keyword','noo') ?>" value="<?php echo (isset($_GET['s'])) ? esc_attr($_GET['s']) : ''; ?>">
                </div>
            <?php else: ?>
                <input type="hidden" name ="s" value="">
            <?php endif; ?>
...
class Noo_Social_Profile extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$xing_profile      = '<a class="xing" href="'.$xing.'"><i class="fa fa-xing"></i></i></a>';
